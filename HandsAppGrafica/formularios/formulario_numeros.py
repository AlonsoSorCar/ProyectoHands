...
class FormularioNumeros(tk.Toplevel):
    ...
    def controles_barra_superior(self):
        ...
        self.labelTitulo = tk.Label(self.barra_superior, text="HANDS - Números")
    ...
    def controles_menu_lateral(self):
        ...
        self.buttonSaludos = tk.Button(self.menu_lateral, text="  \uf085    Saludos", anchor="w",
                                       font=font_awesome, bd=0, bg="#2a3138", fg="white",
                                       width=ancho_menu, height=alto_menu, command=self.abrir_saludos)
    ...
    def controles_cuerpo_numeros(self):
        self.imagenes_numeros = [
            "LSE_N1.png",
            "LSE_N2.png",
            "LSE_N3.png",
            "LSE_N4.png"
        ...
        for imagen in self.imagenes_numeros:
            ...
            if img:
                ...
                button = Button(cuadricula_frame, image=img, bg="#f1faff", bd=0,
                                command=lambda idx=contador: self.abrir_galeria(idx, self.imagenes_numeros))
                button.image = img
